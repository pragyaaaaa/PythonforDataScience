...
def player_plot_salary(player_dict):
    ...
    for name in player_dict:
        plt.plot(salary[player_dict[name]], c=color[name], ls=line_style[name], marker=mark[name], ms=7,
...
player_plot_salary(players_dict)
